...
// #endif
    ...
    q_weights << 
            15, 15, 15,  //R P Y
            // 0.0, 0.0, 0.0,  //R P Y
            50.0, 50.0, 100.0,     // X Y Z
            // 0.00005, 0.00005, 0.00005,    // WX WY WZ
            // 0.00005, 0.00005, 0.00005,    // WX WY WZ
            0.000025, 0.000025, 0.000025,    // WX WY WZ
            0.00005, 0.00005, 0.00005,  // VX VY vz
...
void State_MPC_Force_Pos::run(){
    ...
    if ( mpc_init_counter > PLAN_HORIZON * 2)  //
    {
        ...
        foot_forces_grf.block< 1, 6>( 0, 0) = foot_forces_grf.block< 1, 6>( 0, 0) * 1.5;
        foot_forces_grf.block< 2, 6>( 0, 0) = foot_forces_grf.block< 2, 6>( 0, 0) * 1.2;
...
void State_MPC_Force_Pos::calcGrf(){
    ...
    root_ang_vel = _lowState->getGyro();
