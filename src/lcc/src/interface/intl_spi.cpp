...
int spi_sr::send_recv(uint16_t *Txdate0, uint16_t *Txdate1){
    uint16_t *Txdate_P;
    for (int i = 0; i < 2; i++){
        if (i == 0)
            Txdate_P = Txdate0;
        ...
        memcpy(txBufferf,Txdate_P,46*sizeof(uint16_t));
        txBufferf[46] = calculateXORChecksum(Txdate_P, 46);
        ...
        // cs.lm_gpio(0);
        if (ioctl( i==0 ? fd_spi0:fd_spi1, SPI_IOC_MESSAGE(1), &trf0) == -1)
        {
...
void spi_sr::pos_loaddate(float  pos0,float   pos1,float   pos2,float  pos3,float   pos4,float   pos5,float   pos6,float   pos7,float   pos8)
{
    ...
    uint16_t spi_pos_tmp0=spifloat_to_uint(pos0,-12.5f,12.5f,16);
    uint16_t spi_pos_tmp1=spifloat_to_uint(pos1,-12.5f,12.5f,16);
    uint16_t spi_pos_tmp2=spifloat_to_uint(pos2,-12.5f,12.5f,16);
    uint16_t spi_pos_tmp3=spifloat_to_uint(pos3,-12.5f,12.5f,16);
    uint16_t spi_pos_tmp4=spifloat_to_uint(pos4,-12.5f,12.5f,16);
    uint16_t spi_pos_tmp5=spifloat_to_uint(pos5,-12.5f,12.5f,16);
    uint16_t spi_pos_tmp6=spifloat_to_uint(pos6,-12.5f,12.5f,16);
    uint16_t spi_pos_tmp7=spifloat_to_uint(pos7,-12.5f,12.5f,16);
    uint16_t spi_pos_tmp8=spifloat_to_uint(pos8,-12.5f,12.5f,16);

    uint16_t spi_vel_tmp=spifloat_to_uint(spi_vel,-30.0f,30.0f,12);		
    uint16_t spi_kp_tmp=spifloat_to_uint(spi_KP,0.0f,500.0f,12);
    uint16_t spi_kd_tmp=spifloat_to_uint(spi_KD,0.0f,5.0f,12);
    uint16_t spi_tor_tmp=spifloat_to_uint(spi_trop,-10.0f,10.0f,12);
    loadmag[0] = 0x2255;

            loadmag[1]=spi_pos_tmp0;
            loadmag[2]=spi_vel_tmp;
            loadmag[3]=spi_kp_tmp;
            loadmag[4]=spi_kd_tmp;
            loadmag[5]=spi_tor_tmp;

            loadmag[6]=spi_pos_tmp1;
            loadmag[7]=spi_vel_tmp;
            loadmag[8]=spi_kp_tmp;
            loadmag[9]=spi_kd_tmp;
            loadmag[10]=spi_tor_tmp;

            loadmag[11]=spi_pos_tmp2;
            loadmag[12]=spi_vel_tmp;
            loadmag[13]=spi_kp_tmp;
            loadmag[14]=spi_kd_tmp;
            loadmag[15]=spi_tor_tmp;

            loadmag[16]=spi_pos_tmp3;
            loadmag[17]=spi_vel_tmp;
            loadmag[18]=spi_kp_tmp;
            loadmag[19]=spi_kd_tmp;
            loadmag[20]=spi_tor_tmp;

            loadmag[21]=spi_pos_tmp4;
            loadmag[22]=spi_vel_tmp;
            loadmag[23]=spi_kp_tmp;
            loadmag[24]=spi_kd_tmp;
            loadmag[25]=spi_tor_tmp;

            loadmag[26]=spi_pos_tmp5;
            loadmag[27]=spi_vel_tmp;
            loadmag[28]=spi_kp_tmp;
            loadmag[29]=spi_kd_tmp;
            loadmag[30]=spi_tor_tmp;

            loadmag[31]=spi_pos_tmp6;
            loadmag[32]=spi_vel_tmp;
            loadmag[33]=spi_kp_tmp;
            loadmag[34]=spi_kd_tmp;
            loadmag[35]=spi_tor_tmp;

            loadmag[36]=spi_pos_tmp7;
            loadmag[37]=spi_vel_tmp;
            loadmag[38]=spi_kp_tmp;
            loadmag[39]=spi_kd_tmp;

            loadmag[41]=spi_pos_tmp8;
            loadmag[42]=spi_vel_tmp;
            loadmag[43]=spi_kp_tmp;
            loadmag[44]=spi_kd_tmp;
            loadmag[45]=spi_tor_tmp;
...
void spi_sr::pos_loaddate2(float  pos0,float   pos1,float   pos2,float  pos3,float   pos4,float   pos5,float   pos6,float   pos7,float   pos8)
{
    ...
    uint16_t spi_tor_tmp=spifloat_to_uint(spi_trop,-10.0f,10.0f,12);
        ...
        loadmag2[0]=0x2244;
            ...
            loadmag2[2] = spi_vel_tmp;
            loadmag2[3] = spi_kp_tmp;
            loadmag2[4] = spi_kd_tmp;
            loadmag2[5] = spi_tor_tmp;

            loadmag2[6] = spi_pos_tmp1;
            loadmag2[7] = spi_vel_tmp;
            loadmag2[8] = spi_kp_tmp;
            loadmag2[9] = spi_kd_tmp;
            loadmag2[10] = spi_tor_tmp;

            loadmag2[11] = spi_pos_tmp2;
            loadmag2[12] = spi_vel_tmp;
            loadmag2[13] = spi_kp_tmp;
            loadmag2[14] = spi_kd_tmp;
            loadmag2[15] = spi_tor_tmp;

            loadmag2[16] = spi_pos_tmp3;
            loadmag2[17] = spi_vel_tmp;
            loadmag2[18] = spi_kp_tmp;
            loadmag2[19] = spi_kd_tmp;
            loadmag2[20] = spi_tor_tmp;

            loadmag2[21] = spi_pos_tmp4;
            loadmag2[22] = spi_vel_tmp;
            loadmag2[23] = spi_kp_tmp;
            loadmag2[24] = spi_kd_tmp;
            loadmag2[25] = spi_tor_tmp;

            loadmag2[26] =spi_pos_tmp5;
            loadmag2[27] =spi_vel_tmp;
            loadmag2[28] =spi_kp_tmp;
            loadmag2[29] =spi_kd_tmp;
            loadmag2[30] =spi_tor_tmp;

            loadmag2[31]=spi_pos_tmp6;
            loadmag2[32]=spi_vel_tmp;
            loadmag2[33]=spi_kp_tmp;
            loadmag2[34]=spi_kd_tmp;
            loadmag2[35]=spi_tor_tmp;

            loadmag2[36]=spi_pos_tmp7;
            loadmag2[37]=spi_vel_tmp;
            loadmag2[38]=spi_kp_tmp;
            loadmag2[39]=spi_kd_tmp;
            loadmag2[40]=spi_tor_tmp;

            loadmag2[41]=spi_pos_tmp8;
            loadmag2[42]=spi_vel_tmp;
            loadmag2[43]=spi_kp_tmp;
            loadmag2[44]=spi_kd_tmp;
            loadmag2[45]=spi_tor_tmp;
...
//     usleep(200);
//     send_date2(motor_enable0);//远离电源侧S2	//靠近电源侧
//     usleep(2000);
// }
