...
void IOROS::initSend(){
    // ROS publisher
    pub_joint_cmd[0] = nh.advertise<std_msgs::Float64>("/hexapod_v3/rfj1_jointcc/command", 1000);
    pub_joint_cmd[1] = nh.advertise<std_msgs::Float64>("/hexapod_v3/rfj2_jointcc/command", 1000);
    pub_joint_cmd[2] = nh.advertise<std_msgs::Float64>("/hexapod_v3/rfj3_jointcc/command", 1000);

    pub_joint_cmd[3] = nh.advertise<std_msgs::Float64>("/hexapod_v3/lfj5_jointcc/command", 1000);
    pub_joint_cmd[4] = nh.advertise<std_msgs::Float64>("/hexapod_v3/lfj6_jointcc/command", 1000);
    pub_joint_cmd[5] = nh.advertise<std_msgs::Float64>("/hexapod_v3/lfj7_jointcc/command", 1000);

    pub_joint_cmd[6] = nh.advertise<std_msgs::Float64>("/hexapod_v3/rmj9_jointcc/command", 1000);
    pub_joint_cmd[7] = nh.advertise<std_msgs::Float64>("/hexapod_v3/rmj10_jointcc/command", 1000);
    pub_joint_cmd[8] = nh.advertise<std_msgs::Float64>("/hexapod_v3/rmj11_jointcc/command", 1000);

    pub_joint_cmd[9] = nh.advertise<std_msgs::Float64>("/hexapod_v3/lmj13_jointcc/command", 1000);
    pub_joint_cmd[10] = nh.advertise<std_msgs::Float64>("/hexapod_v3/lmj14_jointcc/command", 1000);
    pub_joint_cmd[11] = nh.advertise<std_msgs::Float64>("/hexapod_v3/lmj15_jointcc/command", 1000);

    pub_joint_cmd[12] = nh.advertise<std_msgs::Float64>("/hexapod_v3/rbj17_jointcc/command", 1000);
    pub_joint_cmd[13] = nh.advertise<std_msgs::Float64>("/hexapod_v3/rbj18_jointcc/command", 1000);
    pub_joint_cmd[14] = nh.advertise<std_msgs::Float64>("/hexapod_v3/rbj19_jointcc/command", 1000);

    pub_joint_cmd[15] = nh.advertise<std_msgs::Float64>("/hexapod_v3/lbj21_jointcc/command", 1000);
    pub_joint_cmd[16] = nh.advertise<std_msgs::Float64>("/hexapod_v3/lbj22_jointcc/command", 1000);
    pub_joint_cmd[17] = nh.advertise<std_msgs::Float64>("/hexapod_v3/lbj23_jointcc/command", 1000);
...
void doMsg_yobotics_joint_states(const sensor_msgs::JointState::ConstPtr& sub_joint_states)
{
    ...
    // $ rostopic echo /hexapod_v3/joint_states
    // name: 
    //   - lbj16
    //   - lbj17
    //   - lbj18
   ...
   //  0~18: RF LF RM LM RB LB 
    ...
    sub_joint_p_local(7) = -sub_joint_p_local(7);
    sub_joint_p_local(13) = -sub_joint_p_local(13);

    sub_joint_p_local(4) = -sub_joint_p_local(4);
    sub_joint_p_local(11) = -sub_joint_p_local(11);
    sub_joint_p_local(17) = -sub_joint_p_local(17);
    ...
    sub_joint_v_local(7) = -sub_joint_v_local(7);
    sub_joint_v_local(13) = -sub_joint_v_local(13);

    sub_joint_v_local(4) = -sub_joint_v_local(4);
    sub_joint_v_local(11) = -sub_joint_v_local(11);
    sub_joint_v_local(17) = -sub_joint_v_local(17);
    ...
    sub_joint_t_local(7) = -sub_joint_t_local(7);
    sub_joint_t_local(13) = -sub_joint_t_local(13);

    sub_joint_t_local(4) = -sub_joint_t_local(4);
    sub_joint_t_local(11) = -sub_joint_t_local(11);
    sub_joint_t_local(17) = -sub_joint_t_local(17);
...
void IOROS::initRecv(){
    sub_joint_states = nh.subscribe<sensor_msgs::JointState>("/hexapod_v3/joint_states",1,doMsg_yobotics_joint_states);
...
void IOROS::sendCmd(const LowlevelCmd *lowCmd, LowlevelState *state){
    ...
    if( wait_count >= 150 )
    {
        ...
        pub_data[11].data =  -pub_data[11].data;
        pub_data[17].data =  -pub_data[17].data;
