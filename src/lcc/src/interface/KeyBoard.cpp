    ...
    switch (_c){
        ...
        case 'G':case 'g':{
            ...
            if( GAIT_SCHEDULER_SWITCH_INDEX == 0 )
            {
                ...
                std::cout<<"GAIT_SCHEDULER_SWITCH_INDEX:  ->CPG"<< GAIT_SCHEDULER_SWITCH_INDEX <<std::endl;

            }
            else if( GAIT_SCHEDULER_SWITCH_INDEX == 1 )
            {
                GAIT_SCHEDULER_SWITCH_INDEX = 0; // 0 -> MIT
                std::cout<<"GAIT_SCHEDULER_SWITCH_INDEX:  -> MIT"<< GAIT_SCHEDULER_SWITCH_INDEX <<std::endl;
            }
        }
        break;
        ...
        case ',':case '<':{
            GAIT_INDEX = 0;
            std::cout<<"GAIT_INDEX:  trot"<< GAIT_INDEX <<std::endl;
        }
        break;
        case '.':case '>':{
            GAIT_INDEX = 1;
            std::cout<<"GAIT_INDEX:  walk"<< GAIT_INDEX <<std::endl;
        }
        break;
        case '/':case '?':{
            GAIT_INDEX = 2;
            std::cout<<"GAIT_INDEX:  claw"<< GAIT_INDEX <<std::endl;
        }
        break;
