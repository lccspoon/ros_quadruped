...
void TerrianEsti::terrain_adaptation(Vec3 _posBody, double _yawCmd, Vec3 &root_euler_d, VecInt4 *_contact, Vec34 _posFeet2BGlobal, Vec3 *_Apla ){
        ...
        // root_euler_d(0) = asin( kethai(1) );
        // root_euler_d(1) = atan( kethai(0) / kethai(2) );
        ...
        // std::cout<<" 0:  "<<  asin( kethai(1) ) * 180 /3.14 <<std::endl;
        // std::cout<<" 1:  "<<  atan( kethai(0) / kethai(2) ) * 180 /3.14 <<std::endl;
