...
//lcc 20250405   选择默认步态
#define GAIT_DEFAULT_TROT true
// #define GAIT_DEFAULT_WALK true
// #define GAIT_DEFAULT_CLAW true

// lcc 20250416 转移到keyboard.cpp中变成全局变量，用键盘控制: 'G' 'g'
// //lcc 20250405  选择默认步态色生成器
// #define GAIT_SCHEDUL_DEFAULT_CPG true
// // #define GAIT_SCHEDUL_DEFAULT_MIT true
...
enum class UserCommand{
    ...
    FORCE_POS_WBC_7,        //lcc 20250405, 力位混合+WBC
...
enum class FSMStateName{
    ...
    FORCE_POS_WBC,        //lcc 20250405, 力位混合+WBC
