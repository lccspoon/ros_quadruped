...
class CPG
{
    ...
    public:
        ...
        void gaitChange( double _gait, double _control_cycle, double _T);

        // double gait=0.5;                      //lcc 20230409:   gait=0.5 默认为三角步态
        // double gait=0.6666;                      //lcc 20230409:   gait=0.5 默认为三角步态
        double gait=0.8333;                      //lcc 20230409:   gait=0.5 默认为三角步态
        // double control_cycle=0.002,T=0.55;       
        double control_cycle=0.002,T=3;       
